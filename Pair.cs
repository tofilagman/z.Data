...
namespace z.Data
{
    ...
    /// </summary>
    [Serializable]
    public class Pair : Dictionary<string, object>, IDisposable //, IEnumerable<KeyValuePair<string, object>>, IEnumerable, ISerializable, IDeserializationCallback
    {
       // private Dictionary<string, object> dc = new Dictionary<string, object>(StringComparer.OrdinalIgnoreCase);
